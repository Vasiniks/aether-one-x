...
export const STAGE_LIGHTING: Record<string, StageLightState> = {
  ...
  xray: { envIntensity: 0.6, key: 0.48, fill: 0.22, rim: 0.6, accent: 1.15, accentPosition: [0, 0, 0.18], accentColor: '#5fa8ff', interiorGlow: 2.4, baseColor: '#010308', topColor: '#050b16' },
  chip: { envIntensity: 1.55, key: 1.5, fill: 0.55, rim: 1.15, accent: 1.6, accentPosition: [0.011, 0.055, 0.03], accentColor: '#ffd27f', interiorGlow: 0.9, baseColor: '#070a14', topColor: '#141b30' },
  ...
  battery: { envIntensity: 0.8, key: 0.6, fill: 0.3, rim: 0.95, accent: 1.5, accentPosition: [-0.01, -0.045, 0.12], accentColor: '#59d9c4', interiorGlow: 1.0, baseColor: '#040a10', topColor: '#0a1820' },
