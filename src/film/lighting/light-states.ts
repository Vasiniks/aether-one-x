...
export const STAGE_LIGHTING: Record<string, StageLightState> = {
  arrival: { envIntensity: 0.55, key: 0.7, fill: 0.3, rim: 1.55, rimR: 0.4, under: 0.18, accent: 0.15, accentPosition: [-0.18, 0.08, 0.42], accentColor: '#7fb0ff', interiorGlow: 0, interiorColor: '#7fb4ff', interiorPosition: [0, 0, 0], baseColor: '#030409', topColor: '#0a0e16' },
  ...
  xray: { envIntensity: 0.7, key: 0.55, fill: 0.3, rim: 0.85, rimR: 0.38, under: 0.2, accent: 1.2, accentPosition: [0.008, 0.05, 0.012], accentColor: '#5fa8ff', interiorGlow: 1.5, interiorColor: '#5fb2ff', interiorPosition: [0, 0.02, 0], baseColor: '#010308', topColor: '#050b16' },
  chip: { envIntensity: 1.55, key: 1.55, fill: 0.55, rim: 1.1, rimR: 0.62, under: 0.26, accent: 1.6, accentPosition: [0.011, 0.052, 0.02], accentColor: '#ffd27f', interiorGlow: 0.6, interiorColor: '#ffb866', interiorPosition: [0.011, 0.052, 0.008], baseColor: '#070a14', topColor: '#141b30' },
  ...
  camera: { envIntensity: 1.4, key: 1.25, fill: 0.55, rim: 1.7, rimR: 0.65, under: 0.28, accent: 0.95, accentPosition: [0.006, 0.045, 0.04], accentColor: '#cfe6ff', interiorGlow: 0, interiorColor: '#7fb4ff', interiorPosition: [0, 0, 0], baseColor: '#05070d', topColor: '#0b1424' },
  ...
  battery: { envIntensity: 0.95, key: 0.8, fill: 0.42, rim: 1.25, rimR: 0.5, under: 0.28, accent: 1.35, accentPosition: [0.12, 0.008, 0.03], accentColor: '#62e6c9', interiorGlow: 1.2, interiorColor: '#4fd6bb', interiorPosition: [0.12, 0, 0.002], baseColor: '#040a10', topColor: '#0a1820' },
